    ...
    <header className="sticky top-0 z-40 border-b border-border bg-surface/95 backdrop-blur supports-[backdrop-filter]:bg-surface/80">
      <div className="flex h-14 items-center gap-2 px-3 sm:px-4">
        ...
        <button
          type="button"
          onClick={onAddStream}
          className="inline-flex items-center gap-1.5 rounded-lg bg-[#1c1935] px-3 py-1.5 text-sm font-semibold text-white shadow-card hover:bg-accent-hover focus-visible:outline focus-visible:outline-2 focus-visible:outline-accent focus-visible:outline-offset-2"
        >
